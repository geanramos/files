! function(e, t) {
    ...
    var d = function(n) {
        var e, d, b, o, i, h, f, g, w, u, l, T, C, a, S, v, s, c, m, E = "sizzle" + 1 * new Date,
            y = n.document,
            k = 0,
            r = 0,
            p = ae(),
        ...
        for (e in d = oe.support = {}, i = oe.isXML = function(e) {
                ...
                return r !== C && 9 === r.nodeType && r.documentElement && (a = (C = r).documentElement, S = !i(C), y !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", re, !1) : n.attachEvent && n.attachEvent("onunload", re)), d.attributes = ue(function(e) {
                ...
                }, s = [], v = [], (d.qsa = G.test(C.querySelectorAll)) && (ue(function(e) {
                ...
                })), (d.matchesSelector = G.test(c = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector)) && ue(function(e) {
                    d.disconnectedMatch = c.call(e, "*"), c.call(e, "[s!='']:x"), s.push("!=", M)
                }), v = v.length && new RegExp(v.join("|")), s = s.length && new RegExp(s.join("|")), t = G.test(a.compareDocumentPosition), m = t || G.test(a.contains) ? function(e, t) {
                ...
                if ((e.ownerDocument || e) !== C && T(e), t = t.replace(U, "='$1']"), d.matchesSelector && S && !N[t + " "] && (!s || !s.test(t)) && (!v || !v.test(t))) try {
                    var n = c.call(e, t);
                        ...
                        return 1 === g && 0 === v ? function(e) {
                            ...
                            if (c) {
                                ...
                                if (u = [y ? c.firstChild : c.lastChild], y && p) {
                                    for (d = (s = (r = (i = (o = (a = c)[E] || (a[E] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === k && r[1]) && r[2], a = s && c.childNodes[s]; a = ++s && a && a[l] || (d = s = 0) || u.pop();)
                                    ...
                                    for (;
                                        (a = ++s && a && a[l] || (d = s = 0) || u.pop()) && ((x ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++d || (p && ((i = (o = a[E] || (a[E] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [k, d]), a !== e)););
                ...
                if (t = b.relative[e[s].type]) c = [ye(xe(c), t)];
                    ...
                    if ((t = b.filter[e[s].type].apply(null, e[s].matches))[E]) {
                        ...
                        return we(1 < s && xe(c), 1 < s && me(e.slice(0, s - 1).concat({
                            value: " " === e[s - 2].type ? "*" : ""
                        })).replace(B, "$1"), t, s < n && Te(e.slice(s, n)), n < r && Te(e = e.slice(n)), n < r && me(e))
                    }
                    c.push(t)
                } return xe(c)
        }
        return ve.prototype = b.filters = b.pseudos, b.setFilters = new ve, h = oe.tokenize = function(e, t) {
            ...
            for (a = e, s = [], u = b.preFilter; a;) {
                for (o in n && !(r = W.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(i = [])), n = !1, (r = _.exec(a)) && (n = r.shift(), i.push({
                        value: n,
                        type: r[0].replace(B, " ")
            ...
            if (!a) {
                ...
                (a = N(e, (v = o, m = i, y = 0 < m.length, x = 0 < v.length, r = function(e, t, n, r, i) {
                    var o, a, s, u = 0,
                        l = "0",
                        c = e && [],
                        f = [],
                    ...
                    for (i && (w = t === C || t || i); l !== g && null != (o = d[l]); l++) {
                        if (x && o) {
                            for (a = 0, t || o.ownerDocument === C || (T(o), n = !S); s = v[a++];)
                                if (s(o, t || C, n)) {
                                    r.push(o);
                                    break
                                } i && (k = h)
        ...
        }, d.sortStable = E.split("").sort(A).join("") === E, d.detectDuplicates = !!l, T(), d.sortDetached = ue(function(e) {
    ...
    (E.fn.init = function(e, t, n) {
        ...
        if (r[1]) {
            if (t = t instanceof E ? t[0] : t, E.merge(this, E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : S, !0)), A.test(r[1]) && E.isPlainObject(t))
                ...
                a = {
                    ...
                    then: function(t, n, r) {
                                ...
                                var n = this,
                                    ...
                                    e = function() {
                                        ...
                                        if (!(i < u)) {
                                            ...
                                            t = e && ("object" == typeof e || "function" == typeof e) && e.then, y(t) ? s ? t.call(e, l(u, o, R, s), l(u, o, $, s)) : (u++, t.call(e, l(u, o, R, s), l(u, o, $, s), l(u, o, R, o.notifyWith))) : (a !== R && (n = void 0, r = [e]), (s || o.resolveWith)(n, r))
                                        }
                                    },
                                    t = s ? e : function() {
                                        try {
                                            ...
                                            E.Deferred.exceptionHook && E.Deferred.exceptionHook(e, t.stackTrace), u <= i + 1 && (a !== $ && (n = void 0, r = [e]), o.rejectWith(n, r))
                                        }
                                    };
                        ...
                        return E.Deferred(function(e) {
                            o[0][3].add(l(0, e, y(r) ? r : R, e.notifyWith)), o[1][3].add(l(0, e, y(t) ? t : R)), o[2][3].add(l(0, e, y(n) ? n : $))
                        }).promise()
                    },
                    promise: function(e) {
    ...
    function B() {
        S.removeEventListener("DOMContentLoaded", B), C.removeEventListener("load", B), E.ready()
    }
    ...
    }), E.ready.then = F.then, "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? C.setTimeout(E.ready) : (S.addEventListener("DOMContentLoaded", B), C.addEventListener("load", B));
    ...
    E.event = {
        ...
        add: function(t, e, n, r, i) {
            ...
            if (v)
                for (n.handler && (n = (o = n).handler, i = o.selector), i && E.find.matchesSelector(ye, i), n.guid || (n.guid = E.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function(e) {
                        return void 0 !== E && E.event.triggered !== e.type ? E.event.dispatch.apply(t, arguments) : void 0
                    }), l = (e = (e || "").match(P) || [""]).length; l--;) d = g = (s = we.exec(e[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = E.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = E.event.special[d] || {}, c = E.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
    ...
    function He(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            G.hasData(e) && (s = G.access(e), u = E.extend({}, s), G.set(t, u))
        }
    }
    ...
    function Oe(n, r, i, o) {
        ...
        if (f && (t = (e = me(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (s = (a = E.map(pe(e, "script"), qe)).length; c < f; c++) u = e, c !== p && (u = E.clone(u, !0, !0), s && E.merge(a, pe(u, "script"))), i.call(n[c], u, c);
            if (s)
                for (l = a[a.length - 1].ownerDocument, E.map(a, Le), c = 0; c < s; c++) u = a[c], ce.test(u.type || "") && !Y.access(u, "globalEval") && E.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? E._evalUrl && E._evalUrl(u.src) : b(u.textContent.replace(De, ""), l, u))
        }
        return n
    }
    ...
    function Me(e, t, n) {
        ...
        return (n = n || $e(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || E.contains(e.ownerDocument, e) || (a = E.style(e, t)), !m.pixelBoxStyles() && Re.test(a) && Ie.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function Fe(e, t) {
        ...
        var n, r, i, o, a, s = S.createElement("div"),
    ...
    function Ge(e, t, n) {
        ...
        return a = a && (m.boxSizingReliable() || i === e.style[t]), ("auto" === i || !parseFloat(i) && "inline" === E.css(e, "display", !1, r)) && (i = e["offset" + t[0].toUpperCase() + t.slice(1)], a = !0), (i = parseFloat(i) || 0) + Ye(e, t, n || (o ? "border" : "content"), a, r, i) + "px"
    }
    ...
    E.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (o = typeof n) && (i = te.exec(n)) && i[1] && (n = oe(e, t, i), o = "number"), null != n && n == n && ("number" === o && (n += i && i[3] || (E.cssNumber[s] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = X(t);
            return We.test(t) || (t = Ve(s)), (a = E.cssHooks[t] || E.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Me(e, t, r)), "normal" === i && t in Ue && (i = Ue[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), E.each(["height", "width"], function(e, s) {
        E.cssHooks[s] = {
            get: function(e, t, n) {
                if (t) return !Be.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, s, n) : ie(e, _e, function() {
                    return Ge(e, s, n)
                })
            },
            set: function(e, t, n) {
                var r, i = $e(e),
                    ...
                    a = n && Ye(e, s, n, o, i);
                return o && m.scrollboxSize() === i.position && (a -= Math.ceil(e["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(i[s]) - Ye(e, s, "border", !1, i) - .5)), a && (r = te.exec(t)) && "px" !== (r[3] || "px") && (e.style[s] = t, t = E.css(e, s)), Qe(0, t, a)
            }
        }
    }), E.cssHooks.marginLeft = Fe(m.reliableMarginLeft, function(e, t) {
        if (t) return (parseFloat(Me(e, "marginLeft")) || e.getBoundingClientRect().left - ie(e, {
            marginLeft: 0
        }, function() {
    ...
    function ut(o, e, t) {
        ...
        for (function(e, t) {
            ...
            if (n = ut.prefilters[r].call(l, o, c, l.opts)) return y(n.stop) && (E._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n;
        return E.map(c, st, l), y(l.opts.start) && l.opts.start.call(o, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), E.fx.timer(E.extend(u, {
            elem: o,
            anim: l,
            queue: l.opts.queue
        })), l
    ...
    E.Animation = E.extend(ut, {
        ...
        tweener: function(e, t) {
            for (var n, r = 0, i = (e = y(e) ? (t = e, ["*"]) : e.match(P)).length; r < i; r++) n = e[r], ut.tweeners[n] = ut.tweeners[n] || [], ut.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            ...
            for (r in n.queue || (null == (a = E._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function() {
                ...
                for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = Y.get(e, "display")), "none" === (c = E.css(e, "display")) && (l ? c = l : (se([e], !0), l = e.style.display || l, c = E.css(e, "display"), se([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === E.css(e, "float") && (u || (p.done(function() {
                        h.display = l
    ...
    E.fn.extend({
        ...
        toggleClass: function(i, t) {
            ...
            return "boolean" == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : y(i) ? this.each(function(e) {
                ...
                var e, t, n, r;
                if (a)
                    for (t = 0, n = E(this), r = gt(i); e = r[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
    ...
    E.extend(E.event, {
        trigger: function(e, t, n, r) {
            ...
            if (o = f = a = n = n || S, 3 !== n.nodeType && 8 !== n.nodeType && !mt.test(d + E.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, (e = e[E.expando] ? e : new E.Event(d, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : E.makeArray(t, [e]), c = E.event.special[d] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!r && !c.noBubble && !x(n)) {
    ...
    E.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !E(this).is(":disabled") && Et.test(this.nodeName) && !St.test(e) && (this.checked || !ue.test(e))
            }).map(function(e, t) {
                var n = E(this).val();
    ...
    Rt.href = xt.href, E.extend({
        ...
        ajax: function(e, t) {
            ...
            var c, f, p, n, d, r, h, g, i, o, v = E.ajaxSetup({}, t),
                m = v.context || v,
    ...
    E.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ut, "$1" + r) : !1 !== e.jsonp && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            ...
            void 0 === i ? E(C).removeProp(r) : C[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, _t.push(r)), o && y(i) && i(o[0]), o = i = void 0
        }), "script"
    }), m.createHTMLDocument = ((Wt = S.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Wt.childNodes.length), E.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (m.createHTMLDocument ? ((r = (t = S.implementation.createHTMLDocument("")).createElement("base")).href = S.location.href, t.head.appendChild(r)) : t = S), o = !n && [], (i = A.exec(e)) ? [t.createElement(i[1])] : (i = me([e], t, o), o && o.length && E(o).remove(), E.merge([], i.childNodes)));
        var r, i, o
    }, E.fn.load = function(e, t, n) {
        var r, i, o, a = this,
            s = e.indexOf(" ");
        return -1 < s && (r = dt(e.slice(s)), e = e.slice(0, s)), y(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), 0 < a.length && E.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
        ...
        E.cssHooks[n] = Fe(m.pixelPosition, function(e, t) {
            if (t) return t = Me(e, n), Re.test(t) ? E(e).position()[n] + "px" : t
        })
    }), E.each({
        Height: "height",
        Width: "width"
    ...
    }, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = N, E.isFunction = y, E.isWindow = x, E.camelCase = X, E.type = w, E.now = Date.now, E.isNumeric = function(e) {
        var t = E.type(e);
    ...
    return E.noConflict = function(e) {
        return C.$ === E && (C.$ = Xt), e && C.jQuery === E && (C.jQuery = zt), E
    }, e || (C.jQuery = C.$ = E), E
}),
function(e, t) {
    window.csEnvID = "uol";
    var n = {
        ...
        date: {
            hour: ["sort_by", "date-sdate:h"],
            day: ["sort_by", "date-sdate:d"],
            week: ["sort_by", "date-sdate:w"],
            month: ["sort_by", "date-sdate:m"],
            year: ["sort_by", "date-sdate:y"]
        }
    };

    function r() {
        var r, e = [],
            t = (r = {}, window.location.search.replace(/[?&]+([^=&]+)=([^&]*)/gi, function(e, t, n) {
                r[decodeURIComponent(t)] = decodeURIComponent(n)
            }), r);
        for (key in t) n.hasOwnProperty(key) && n[key].hasOwnProperty(t[key]) && e.push({
            parm: n[key][t[key]][0],
            term: n[key][t[key]][1]
        });
        return e
    ...
    e.init = function(e) {
        e.elem ? function(e, t) {
            var n = document.createElement("gcse:searchresults"),
                r = "*." + ("www" == window.csEnvID ? "*.www." : "") + "gean.me/*";
            n.setAttribute("queryParameterName", "term"), n.setAttribute("as_sitesearch", r), n.setAttribute("disableWebSearch", "false"), n.setAttribute("gname", "buscaBox");
            for (var i = 0; i < e.length; i++) n.setAttribute(e[i].parm, e[i].term);
            document.querySelector(t).appendChild(n)
        }(r(), e.elem) : console.warn("[ERRO] Elemento não Definido")
    }
}(window.parseUrl = window.parseUrl || {}), window.openInternalURL = function(e) {
    currentQuery = document.querySelector(".gsc-input input").value, e += currentQuery, window.location.href = e
}, document.querySelector("#footer-date").innerText = (new Date).getFullYear(), window.parseUrl.init({
    elem: ".search-output-content"
});
var TypeValidator = {
        ...
        isString: function(e) {
            return void 0 !== e && "string" == typeof e && this.stringIsNotEmpty(e)
        },
        stringIsNotEmpty: function(e) {
            return 0 < (e = e.replace(/^(\s+)|(\s+)$/gm, "").replace(/\s+/gm, " ")).length
        },
        isArray: function(e) {
            return e && e.constructor === Array
        },
        arrayIsNotEmpty: function(e) {
        ...
        isFunction: function(e) {
            return void 0 !== e && e.constructor === Function
        },
        isNumber: function(e) {
            return Number(e) === e
        },
        ...
        isRegExp: function(e) {
            return void 0 !== e && e.constructor === RegExp
        },
        isNumericString: function(e) {
            return this.isString(e) && !isNaN(e)
        },
        isBoolean: function(e) {
            return void 0 !== e && e.constructor == Boolean
        },
        isJson: function(e) {
            try {
                e = JSON.parse(e)
        ...
        isUrl: function(e) {
            return /(http|https):\/\/(\w+:{0,1}\w*)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%!\-\/]))?/gi.test(e)
        },
        isNotMetric: function(e) {
            return !this.isDefined(e) || !(this.isBoolean(e) || this.isNumber(e) || this.isString(e))
        }
    },
    QueryString = {
        get: function(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : document.location.href;
            if (e && this.hasQueryString(t)) {
                var n = t.split("?")[1].split("&"),
                    r = void 0,
                    i = void 0;
                for (r = 0; r < n.length; r++)
                    if (-1 !== (i = n[r].split(/\=(.+)?/))[0].indexOf(e)) return decodeURIComponent(i[1].replace(/\+/g, " "))
            }
            return !1
        },
        getAll: function() {
            var e = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : window.location.href).split("?");
            return (e = e[1] ? e[1].split("&") : "") || ""
        },
        update: function(e, t) {
            var n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : document.location.href;
            if (TypeValidator.isString(e) && TypeValidator.isString(t))
                if (this.get(e, n)) {
                    var r = this.getAll(),
                        i = void 0,
                        o = void 0;
                    for (o = 0; o < r.length; o++)(i = r[o].split("="))[0] === e && (i[1] = t, r[o] = i.join("="));
                    n = n.split("?")[0] + "?" + r.join("&")
                } else n = this.insert(e, t, n);
            return n || ""
        },
        insert: function(e, t) {
            var n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : document.location.href;
            return TypeValidator.isString(e) && TypeValidator.isString(t) && (this.get(e, n) ? n = this.update(e, t, n) : this.hasQueryString(n) ? n += "&" + e + "=" + t : n += "?" + e + "=" + t), n || ""
        },
        remove: function(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : document.location.href;
            if (TypeValidator.isString(e) && this.get(e, t)) {
                var n = this.getAll(t),
                    r = void 0;
                for (r = 0; r < n.length; r++) n[r].split("=")[0] === e && n.splice(r, 1);
                t = t.split("?")[0] + "?" + n.join("&")
            }
            return t || ""
        },
    ...
    FilterSettings = {
        ...
        language: {
            all: "Em qualquer idioma",
            pt: "Português (Brasil)"
        }
    },
    filterClicked = function(e) {
        document.querySelector(".gsc-input input") && (e = QueryString.remove("term", e), e += "&term=" + document.querySelector(".gsc-input input").value, window.location.href = e)
    },
    MenuHandler = {
        init: function() {
            var e = QueryString.get("term");
            this.inputSearch(), this.menuUrl(e), this.filters(e)
        },
        inputSearch: function() {
            $("#search-form").on("submit", function(e) {
                var t = $("#search-form input").val() || "",
                    n = void 0;
                e.preventDefault(), TypeValidator.isString(t) ? (t = encodeURIComponent(Utils.clearXSS(t.trim())).replace(/\s/g, "+"), n = QueryString.update("term", t), document.location.href = QueryString.remove("page", n)) : $("#search-form input").focus()
            })
        },
        filterAnimation: function() {
            $(".filter").click(function() {
                767 < window.innerWidth && ($(".filter-options").is(":visible") ? $(".search-output-content").css({
                    "margin-top": "-47px"
                }) : $(".search-output-content").css({
                    "margin-top": "-18px"
                })), $(".filter-options").slideToggle("fast"), 600 < $(window).width() && $(".resultsum").slideToggle("fast")
            }), $(".filter-options > li").on("click", function(e) {
                var t = $(this),
                    n = t.offset().left,
                    r = t.find("ul"),
                    i = document.body.clientWidth;
                $(e.target).is(".filter-options a") || (r.hasClass("active") ? r.removeClass("active") : ($(".filter-options li ul").removeClass("active"), r.addClass("active"), r[0] == $(".filter-options ul").last()[0] && i < 600 ? r.css({
                    right: "0px",
                    left: "initial"
                }) : r.css({
                    left: n + "px",
                ...
                $(e.target).is(".filter-options li ul") || $(e.target).is(".filter-options li") || $(e.target).is(".filter-options a") || $(".filter-options li ul").removeClass("active")
            })
        },
        menuUrl: function() {
            var n = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "";
            TypeValidator.isString(n) && $(".menu .intern, .menu .external").each(function(e, t) {
                t.href += n
            })
        },
        filters: function() {
            ...
            var e = "",
                ...
                r = void 0,
                i = void 0;
            for (n in FilterSettings) {
                for (r in t = QueryString.get(n) || "all", e += "<li>", e += FilterSettings[n][t], e += "<ul>", FilterSettings[n]) i = QueryString.update(n, r), e += '<li><a href="javascript:void(0)" onclick=filterClicked(\'' + (i = QueryString.remove("page", i)) + "') class=\"" + (r === t ? "selected" : "") + '" title="Filtro: ' + FilterSettings[n][r] + '">' + FilterSettings[n][r] + "</a></li>";
                e += "</ul>", e += "</li>"
            }
            $(".filter-options").append(e), this.filterAnimation()
        }
    };
